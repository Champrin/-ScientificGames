        ...
        if(in_array($event->getPlayer()->getLevel()->getFolderName(),$this->plugin->world->get("worlds")))
        {
            ...
            switch($item)
            {
                ...
                case 437://肾上腺素 Item:龙息
                    ...
                    $this->plugin->ScientificGames_addEffect($player, Effect::SPEED,  3, 20*60*2,true);
                    $this->plugin->ScientificGames_addEffect($player, Effect::HASTE,  3, 20*60*2,true);
                    $this->plugin->ScientificGames_addEffect($player, Effect::STRENGTH,  3, 20*60*2,true);
        ...
        if(in_array($event->getPlayer()->getLevel()->getFolderName(),$this->plugin->world->get("worlds")))
        {
            ...
            switch($itemid)
            {
                ...
                case 391://胡萝卜---维生素A
                    ...
                    break;
                case 392://马铃薯--中毒
                    $this->plugin->ScientificGames_addEffect($player, Effect::POISON,  1, 20*120,true);
                ...
                case 423://生羊肉
                    ...
                    if($num <= 30)
                    {
                        ...
                        $this->plugin->ScientificGames_addEffect($player, Effect::WEAKNESS, 1, 20 * 120, true);
                        $this->plugin->ScientificGames_addEffect($player, Effect::NAUSEA, 1, 20 * 120, true);
                        $player->sendMessage("  §c你生吃羊肉吃到了寄生虫 \n  §b你得病了");
                        unset($num);
                    }
                    $this->plugin->setExcretion($name,$this->plugin->getExcretion($name)+3.5);
                ...
                case 363://生牛肉
                    ...
                    if($num <= 30)
                    {
                        ...
                        $this->plugin->ScientificGames_addEffect($player, Effect::WEAKNESS, 1, 20 * 120, true);
                        $this->plugin->ScientificGames_addEffect($player, Effect::NAUSEA, 1, 20 * 120, true);
                        $player->sendMessage("  §c你生吃的牛肉中有大肠杆菌 \n  §a所以你生病了~");
                        unset($num);
                    }
                    $this->plugin->setExcretion($name,$this->plugin->getExcretion($name)+3.5);
                ...
                case 411://生兔肉
                    ...
                    if($num <= 30)
                    {
                        ...
                        $this->plugin->ScientificGames_addEffect($player, Effect::WEAKNESS, 1, 20 * 120, true);
                        $this->plugin->ScientificGames_addEffect($player, Effect::NAUSEA, 1, 20 * 120, true);
                        $player->sendMessage("  §c你吃到了带有病菌的生兔肉 \n  §a所以你生病了~");
                        unset($num);
                    }
                    $this->plugin->setExcretion($name,$this->plugin->getExcretion($name)+3.5);
